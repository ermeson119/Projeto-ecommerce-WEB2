...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
                                        .requestMatchers( "/vendas/list", "produtos/area-compra","vendas/carrinho", "usuario/form", "usuario/save").permitAll()
                                        .requestMatchers("/pessoaFisica/list", "/pessoaJuridica/list","/vendas/list", "/produtos/list", "/pessoaFisica/form ","/pessoaJuridica/form","/produtos/form").hasAnyRole("ADMIN")
